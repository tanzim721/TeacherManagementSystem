                ...
                <section class="col-md-12 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-bold">Gallery List</h4>
                            {{-- Ekhane ekta problem: 1.delete kaj korteche na --}}
                            <a class="btn btn-success float-right btn-sm" href="{{route('gallery.add')}}"><i class="fa fa-plus-circle"></i> Add Gallery</a>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody id="gallery_models">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$gallery->name}}</td>
                                        <td>{{$gallery->des}}</td>
                                        <td><img style="width: 45px; height:45px" class="card-img-top" src="{{$gallery->image}}" alt=""></td>
                                        <td>
